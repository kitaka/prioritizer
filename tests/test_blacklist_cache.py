...
class TestBlacklistCache(TestCase):
    def setUp(self):
        ...
        self.cache = BlacklistCache(self.client, "ureport-high-priority-blacklist")
    ...
    def test_blacklist_is_updated_with_new_word(self):
        ...
        self.assertTrue(self.client.sismember(self.cache.get_key_name(), "encrypted_value"))

    def test_that_key_name_is_blacklist(self):
        self.assertEquals(self.cache.get_key_name(), "ureport-high-priority-blacklist")
